const Contact = () => {
  return (
    <div className="">
      <h2 className="text-center font-bold text-3xl my-10 text-[#FF0126]">Contact Us</h2>
      <div className="bg-white flex flex-col lg:flex-row justify-evenly p-10 rounded-xl">
        <div className="w-full lg:w-1/3 mr-10 flex items-center">
          <h2 className="text-5xl text-black font-bold pb-10 ">If you <span className="text-[#FF0126]">interested!</span> Please feel free to <span className="text-[#FF0126]">contact</span> with us.</h2>
        </div>
